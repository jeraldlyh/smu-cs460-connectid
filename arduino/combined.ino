...
String sendReq() {
    if ((WiFiMulti.run() == WL_CONNECTED)) {
        ...
        if (https.begin(*client, "https://cs460-txitm.ondigitalocean.app/sos?name=Wu Kai Ming")) { // HTTPS
            ...
            if (httpCode > 0) {
                ...
                if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) {
                    ...
                    Serial.println(payload.substring(1, 6));
                    return payload.substring(1, 6); // TODO: Have to tweak this one.
                }
            } else {
