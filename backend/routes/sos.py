...
async def request_help():
    ...
    for responder in responders:
        ...
        intersections = set(_get_list_of_existing_experience(responder)).intersection(
            pwid.medical_conditions
        )
        matches_language_preference = pwid.language_preference in responder.languages
